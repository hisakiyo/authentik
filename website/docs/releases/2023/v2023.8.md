...
-   Removal of PostgreSQL 11 support
    ...
    For Kubernetes install, a manual one-time migration has to be done: [Upgrading PostgreSQL on Kubernetes](../../running/postgres_upgrade_kubernetes.md)
...
This release changes the PostgreSQL dependency to require Version 12 or later, which only affects Kubernetes installs. See [here](../../running/postgres_upgrade_kubernetes.md) for more info on upgrading.
